...
const Sidebar = () => {
  ...
  return (
    <div className="w-42 md:w-64 flex-none bg-gray-100 p-6 overflow-y-auto">
      ...
      <div className="flex flex-col">
        <a
          ...
          aria-label="All"
        >
          <FontAwesomeIcon icon={faAsterisk} className="md:mr-2" />
        ...
        {tags.map((tag) => (
          <a
            ...
            aria-label={tag.name}
          >
            <FontAwesomeIcon icon={tag.icon} className="md:mr-2" />
            {/* Show nothing if the screen is extra small */}
            {isExtraSmallScreen
              ? ""
